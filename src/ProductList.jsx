...
const plantsArray = [
  {
    ...
    description: "Aloe Vera is great for skin and easy to care for.",
    cost: "$12.99",
  ...
  },
  {
    ...
    description: "Perfect for indoors, large green leaves.",
    cost: "$25.99",
    categories: ["Indoor"],
  },
  {
    ...
    cost: "$18.50",
    categories: ["Air Purifier", "Indoor"],
  },
];
...
const ProductList = () => {
  ...
  const styles = {
    ...
    button: (isAdded) => ({
      marginTop: "10px",
      padding: "8px 16px",
      backgroundColor: isAdded ? "#aaa" : "#4caf50",
      color: "white",
      border: "none",
      borderRadius: "6px",
      ...
      {plantsArray.map((plant) => {
        ...
        return (
          <div key={plant.name} style={styles.card}>
            ...
            <p style={styles.price}>{plant.cost}</p>
            <button
